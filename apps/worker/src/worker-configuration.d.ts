/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/worker/src/worker-configuration.d.ts` (hash: 28b104dd8bd9e4669d31da7a33fbafe2)
// Runtime types generated with workerd@1.20260623.1 2026-06-30 nodejs_compat
interface __BaseEnv_Env {
  ZHICE_BUCKET: R2Bucket;
  ZHICE_DB: D1Database;
  ASSETS: Fetcher;
  ENVIRONMENT: "production";
  TURNSTILE_SITE_KEY: "0x4AAAAAADtrPF5DctpTzakh";
  MATERIAL_COORDINATOR: DurableObjectNamespace<import("./index").MaterialCoordinator>;
  PDF_WORKFLOW: Workflow<Parameters<import("./index").PdfWorkflow["run"]>[0]["payload"]>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./index");
    durableNamespaces: "MaterialCoordinator";
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "ENVIRONMENT" | "TURNSTILE_SITE_KEY">
  > {}
}
